...
**Adopted:** 21.9454 h, 2P, CANDIDATE
...
|--|--|--|--|--|--|--|--|
| s39 | 1868 | 402.3 | 10.9776 | 0.4324 | 5.8e-225 | 36.7 | 2P-ambiguous |
...
- Coverage: **1 sector(s)**, best sector covers **18.33 cycles** of the adopted period. Measured periodogram peak width 3% of the period, i.e. about **+/- 0.1174 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
...
- doubling: by convention (one prominent maximum in the fold at P1 = 10.9727 h, stable in 100 per cent of block bootstraps, METHODOLOGY 3b-bis); the doubling is NOT established: the calibrated block-bootstrap test is silent (p_emp 0.042 and 0.032 on 20,000 null realisations, against a 0.001 bar) and the two minima differ by 2.0 sigma, below the 3 sigma bar; the folded amplitude at P1 is 0.226 mag, below the 0.40 cut, so the convention here rests on the topology alone; both aliases 10.9727 h and 21.9454 h are to be considered
...
![phase-fold at the adopted period](../plots/13556.png)
<!-- AUTO:END -->
...
2. **One global trend, not one per sector.** A single cubic plus two harmonics over
   the whole 402 h baseline, with the period search capped at
   baseline/8, that is at least eight rotations inside the data.
   Photometric period P1 = 10.9727 h, chi-squared gain 49.6 per cent.
...
4. **Independent subsets.** The two time halves return 11.023 and 21.945 h,
...
**One detecting sector (s39).** The coherence test is therefore between
...
| quantity at P1 = 10.9727 h | value |
|--|--|
| calibrated p, 1 d blocks | 0.04205 |
| calibrated p, 2 d blocks | 0.03160 |
| unequal minima, z above the null mean | +2.00 |
| prominent maxima in the fold (stability) | 1 (100 per cent) |
| folded amplitude at P1 | 0.226 mag |

**Adopted by convention, and the doubling is not established.** The fold at
10.9727 h has a single prominent maximum, stable in 100 per cent of the
...
the rotation period would be 10.9727 h; **both aliases are to be considered.**
...
## Verdict
CANDIDATE 2P / 21.9454 h. The factor of two is adopted by convention and has no per-object evidence; the alias 10.9727 h is to be considered alongside it.
