...
- DIA (de-comb): survived_v2(ret=1.000[1.00-1.00],s65@16.995h)
- Coverage: **2 sector(s)**, best sector covers **26.48 cycles** of the adopted period. Measured periodogram peak width 4% of the period, i.e. about **+/- 0.2804 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
