...
- DIA (de-comb): outofrange_v2(ret=0.838[0.70-0.92],s51@189.620h)
- Coverage: **2 sector(s)**, best sector covers **3.2 cycles** of the adopted period. Measured periodogram peak width 46% of the period, i.e. about **+/- 37.34 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
