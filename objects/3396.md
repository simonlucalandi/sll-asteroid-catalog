...
- Pipeline refine said: **1P** (folded amp_fourier 0.105); flags: gap-alias-risk:62h;sick-dips-excised:s43(1),s44(1);harmonic-only-agreement:s43(pw=0.03);in
- DIA (de-comb): survived_v2(ret=0.974[0.94-1.02],s42@61.963h)
- Coverage: **4 sector(s)**, best sector covers **9.82 cycles** of the adopted period. Measured periodogram peak width 9% of the period, i.e. about **+/- 2.418 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
...
- folded_amp=0.041. Independent LS reruns confirm s27 (P=61.963h, FAP=1.5e-120, 9.3 cyc, max_gap 24.8h) and s42 (P=61.61h, FAP=1.4e-118, 9.8 cyc) genuinely agree to <1% harmonic-aware, satisfying the >=2-sector CONFIRMED bar; wind
