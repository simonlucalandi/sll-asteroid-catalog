...
- DIA (de-comb): survived(dPW=+3%,R2=0.09,s50@2.005h,2sec)
- Coverage: **2 sector(s)**, best sector covers **127.77 cycles** of the adopted period. Measured periodogram peak width 0% of the period, i.e. about **+/- 0.0 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
