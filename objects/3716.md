...
- DIA (de-comb): survived(dPW=+2%,R2=0.28,s43@5.236h,4sec)
- Coverage: **2 sector(s)**, best sector covers **57.3 cycles** of the adopted period. Measured periodogram peak width 1% of the period, i.e. about **+/- 0.02 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
