...
- DIA (de-comb): survived_v2(ret=1.000[1.00-1.00],s42@5.897h)
...
- NOVELTY FIRST RELIABLE (only a U=1 entry existed) (2026-08-16 cross-match against catalogues the ledger could not see): LCDB U=1 publishes 12.0h. NOT a first determination; the paper must present it as such
