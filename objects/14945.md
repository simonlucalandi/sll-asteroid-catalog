...
- DIA (de-comb): survived_v2(ret=0.998[0.99-1.00],s31@11.495h)
- Coverage: **3 sector(s)**, best sector covers **46.94 cycles** of the adopted period. Measured periodogram peak width 2% of the period, i.e. about **+/- 0.1077 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
