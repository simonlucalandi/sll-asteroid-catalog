...
- DIA (de-comb): survived(dPW=+0%,R2=0.32,s42@7.931h,2sec)
- Coverage: **2 sector(s)**, best sector covers **35.61 cycles** of the adopted period. Measured periodogram peak width 1% of the period, i.e. about **+/- 0.04 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
