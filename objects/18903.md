...
- DIA (de-comb): survived_v2(ret=0.999[1.00-1.00],s43@29.532h)
- Coverage: **3 sector(s)**, best sector covers **10.35 cycles** of the adopted period. Measured periodogram peak width 4% of the period, i.e. about **+/- 0.5005 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
