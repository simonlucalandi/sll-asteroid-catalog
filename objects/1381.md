...
- DIA (de-comb): survived_v2(ret=1.000[1.00-1.00],s27@2.629h)
- Coverage: **5 sector(s)**, best sector covers **119.89 cycles** of the adopted period. Measured periodogram peak width 0% of the period, i.e. about **+/- 0.004104 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
...
- 2P by amplitude rule (folded_amp=0.594)
