...
- DIA (de-comb): survived(dPW=-9%,R2=0.50,s8@16.279h,4sec)
- Coverage: **2 sector(s)**, best sector covers **39.95 cycles** of the adopted period. Measured periodogram peak width 2% of the period, i.e. about **+/- 0.16 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
