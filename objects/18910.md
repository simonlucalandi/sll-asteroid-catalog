...
- DIA (de-comb): survived(dPW=+3%,R2=0.24,s32@11.154h,4sec)
- Coverage: **2 sector(s)**, best sector covers **26.69 cycles** of the adopted period. Measured periodogram peak width 2% of the period, i.e. about **+/- 0.07 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
