...
- DIA (de-comb): survived_v2(ret=0.999[1.00-1.00],s83@2.391h)
- Coverage: **3 sector(s)**, best sector covers **121.47 cycles** of the adopted period. Measured periodogram peak width 0% of the period, i.e. about **+/- 0.003732 h** (1 sigma); the decimal places in the adopted value are not a precision claim.
